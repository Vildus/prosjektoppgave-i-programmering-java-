...
public class TestData {
    // this method is only here for testing / filling the inventory with items
    // if the datastore file inventory.jobj is not found
    public static void fillInventory() {
        try {
            ...
            Component component5 = new PowerSupply("HP", "Elite gaming", 40, 230, 24);
            Item item5 = new Item(component5, 700, 7564730);
            item5.setInStock(30);
            Inventory.getInstance().addItem(item5);

            Component component6 = new Processor("HP", "Elite gaming", 4, 2000);
            ...
            Component component29 = new HardDisk("Seagate", "SkyHawk", "HDD", 256);
